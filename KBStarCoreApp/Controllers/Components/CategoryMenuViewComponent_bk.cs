...
namespace KBStarCoreApp.Controllers.Components
{
    ...
    public class CategoryMenuViewComponent_bk : ViewComponent
    {
        private IMemoryCache _memoryCache;
        private IProductCategoryService _productCategoryService;
        public CategoryMenuViewComponent_bk(IProductCategoryService productCategoryService, IMemoryCache memoryCache)
        {
