var productCategoryController = function () {
    ...
    function registerEvents() {
        ...
        //off('click')--> Vo hieu hoa het cac su kien click tranh click 02 lan
        $('#btnCreate').off('click').on('click', function () {
            initTreeDropDownCategory();
            $('#modal-add-edit').modal('show');
        });

        //$('body') dung the body cho truong hop nut edit/delete duoc render sau khi tai du lieu
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            kbstar.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        kbstar.notify('Deleted success', 'success');
                        kbstar.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        kbstar.notify('Update success', 'success');
                    ...
                    error: function () {
                        kbstar.notify('Has an error in update progress', 'error');
                        kbstar.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = kbstar.unflattern(data);
